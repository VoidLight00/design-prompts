# Design Style: High Contrast Landing Page

> **Source:** [SuperDesign — High Contrast Landing Page](https://app.superdesign.dev/library/high-contrast-landing-page)
> **Author:** Shirley Lou
> **Vibe:** A sophisticated, typography-first design system using heavy geometric sans-serifs, offset text layer...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![High Contrast Landing Page Design System](../images/high-contrast-landing-page/reference.png)
