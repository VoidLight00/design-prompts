# Design Style: Cinematic Style

> **Source:** [SuperDesign — Cinematic Style](https://app.superdesign.dev/library/cinematic-style)
> **Author:** Zhou Jason
> **Vibe:** The 'Cinematic Style' is an immersive, dark-mode design system using 3D spatial depth and high-contr...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Cinematic Style Design System](../images/cinematic-style/reference.png)
