# Design Style: Neo-Brutalism Style

> **Source:** [SuperDesign — Neo-Brutalism Style](https://app.superdesign.dev/library/neo-brutalism-style)
> **Author:** Zhou Jason
> **Vibe:** A bold, high-contrast Neo-Brutalist design system featuring heavy strokes, hard shadows, and an 'Aci...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Neo-Brutalism Style Design System](../images/neo-brutalism-style/reference.png)
