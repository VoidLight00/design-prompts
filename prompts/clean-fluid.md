# Design Style: Clean fluid

> **Source:** [SuperDesign — Clean fluid](https://app.superdesign.dev/library/clean-fluid)
> **Author:** Zhou Jason
> **Vibe:** An editorial-tech hybrid style utilizing high-contrast typography, fluid micro-interactions, and a u...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Clean fluid Design System](../images/clean-fluid/reference.png)
