# Design Style: Minimalist Beta Capture

> **Source:** [SuperDesign — Minimalist Beta Capture](https://app.superdesign.dev/library/minimalist-beta-capture)
> **Author:** Shirley Lou
> **Vibe:** A minimalist, dark-themed design system characterized by editorial typography, technical monospace l...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Minimalist Beta Capture Design System](../images/minimalist-beta-capture/reference.png)
