# Design Style: Bold Editorial Studio Style

> **Source:** [SuperDesign — Bold Editorial Studio Style](https://app.superdesign.dev/library/bold-editorial-studio-style)
> **Author:** Zhou Jason
> **Vibe:** A sophisticated, typography-first creative studio aesthetic featuring a black-and-white color scheme...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Bold Editorial Studio Style Design System](../images/bold-editorial-studio-style/reference.png)
