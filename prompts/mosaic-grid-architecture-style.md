# Design Style: Mosaic Grid Architecture Style

> **Source:** [SuperDesign — Mosaic Grid Architecture Style](https://app.superdesign.dev/library/mosaic-grid-architecture-style)
> **Author:** Shirley Lou
> **Vibe:** A sophisticated, structural design system inspired by technical blueprints and high-end UI wireframe...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Mosaic Grid Architecture Style Design System](../images/mosaic-grid-architecture-style/reference.png)
