# Design Style: Chrome Extension Landing Page

> **Source:** [SuperDesign — Chrome Extension Landing Page](https://app.superdesign.dev/library/chrome-extension-landing-page)
> **Author:** Shirley Lou
> **Vibe:** Create a high-density, technical landing page that simulates a browser workspace. The design must fe...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Chrome Extension Landing Page Design System](../images/chrome-extension-landing-page/reference.png)
