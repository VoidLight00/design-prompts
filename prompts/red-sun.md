# Design Style: Red sun

> **Source:** [SuperDesign — Red sun](https://app.superdesign.dev/library/red-sun)
> **Author:** Zhou Jason
> **Vibe:** The Red Sun system uses a bold coral primary color against a deep ink-blue foundation to create a mo...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Red sun Design System](../images/red-sun/reference.jpg)
