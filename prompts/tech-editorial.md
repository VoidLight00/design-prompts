# Design Style: Tech Editorial

> **Source:** [SuperDesign — Tech Editorial](https://app.superdesign.dev/library/tech-editorial)
> **Author:** Zhou Jason
> **Vibe:** A sophisticated editorial-style UI featuring a fixed background grid, high-contrast serif typography...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Tech Editorial Design System](../images/tech-editorial/reference.jpg)
