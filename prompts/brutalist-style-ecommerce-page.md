# Design Style: Brutalist Style Ecommerce Page

> **Source:** [SuperDesign — Brutalist Style Ecommerce Page](https://app.superdesign.dev/library/brutalist-style-ecommerce-page)
> **Author:** Shirley Lou
> **Vibe:** A high-fashion brutalist design system called 'Season 04', utilizing massive typography, raw noise t...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Brutalist Style Ecommerce Page Design System](../images/brutalist-style-ecommerce-page/reference.png)
...
A high-fashion brutalist design system called 'Season 04', utilizing massive typography, raw noise textures, and a technical-utilitarian layout. It blends luxury editorial sensibilities with harsh, industrial design elements like high-contrast grayscale imagery and neon acid-green micro-interactions.
