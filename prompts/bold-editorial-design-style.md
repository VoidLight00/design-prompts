# Design Style: Bold Editorial Design Style

> **Source:** [SuperDesign — Bold Editorial Design Style](https://app.superdesign.dev/library/bold-editorial-design-style)
> **Author:** Shirley Lou
> **Vibe:** Create a high-end, premium portfolio system using a dark navy base (#171e19), massive Anton display ...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Bold Editorial Design Style Design System](../images/bold-editorial-design-style/reference.png)
