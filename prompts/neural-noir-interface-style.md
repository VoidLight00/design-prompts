# Design Style: Neural Noir Interface Style

> **Source:** [SuperDesign — Neural Noir Interface Style](https://app.superdesign.dev/library/neural-noir-interface-style)
> **Author:** Zhou Jason
> **Vibe:** A sophisticated dark-mode interface featuring neural network connectivity, glassmorphism, and a luxu...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Neural Noir Interface Style Design System](../images/neural-noir-interface-style/reference.png)
