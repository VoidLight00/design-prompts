# Design Style: Neon Velocity Countdown

> **Source:** [SuperDesign — Neon Velocity Countdown](https://app.superdesign.dev/library/neon-velocity-countdown)
> **Author:** Shirley Lou
> **Vibe:** The 'Neon Velocity' style guide is a minimalist yet aggressive design system that blends brutalist s...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Neon Velocity Countdown Design System](../images/neon-velocity-countdown/reference.png)
