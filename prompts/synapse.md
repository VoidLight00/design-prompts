# Design Style: Synapse

> **Source:** [SuperDesign — Synapse](https://app.superdesign.dev/library/synapse)
> **Author:** Zhou Jason
> **Vibe:** The Synapse design system is a futuristic, dark-themed interface that combines large-scale editorial...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Synapse Design System](../images/synapse/reference.jpg)
