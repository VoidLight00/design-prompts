# Design Style: Midnight Editorial Style

> **Source:** [SuperDesign — Midnight Editorial Style](https://app.superdesign.dev/library/midnight-editorial-style)
> **Author:** Zhou Jason
> **Vibe:** The 'Midnight Editorial' style blends brutalist typography with high-end fashion aesthetics. It util...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Midnight Editorial Style Design System](../images/midnight-editorial-style/reference.png)
