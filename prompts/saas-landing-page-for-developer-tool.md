# Design Style: SaaS Landing Page for Developer Tool

> **Source:** [SuperDesign — SaaS Landing Page for Developer Tool](https://app.superdesign.dev/library/saas-landing-page-for-developer-tool)
> **Author:** Shirley Lou
> **Vibe:** A sophisticated, 'Reality-First' design system that rejects typical SaaS fluff in favor of a structu...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![SaaS Landing Page for Developer Tool Design System](../images/saas-landing-page-for-developer-tool/reference.png)
...
Rectangular shape with 0px border-radius. Padding: 16px 32px. Font: 14px, Bold, Uppercase, Tracking-wider. Primary variant: Background #1351AA, Text #E3E2DE. Secondary variant: Background #141414, Text #E3E2DE. Hover state: Transition background color to #141414 over 0.3s.

#### Typographic List Item

*Large interactive list items with a sidebar index.*

A container with 1px border-top and no border-radius. Contains a small '00X' index in mono font (#7A7A7A) and a large header (text-5xl, weight-bold). Interaction: On container hover, the header text color changes to #1351AA. Implementation uses a flex-row with 'items-start'.
