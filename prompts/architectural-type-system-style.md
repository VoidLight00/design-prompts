# Design Style: Architectural Type System Style

> **Source:** [SuperDesign — Architectural Type System Style](https://app.superdesign.dev/library/architectural-type-system-style)
> **Author:** Shirley Lou
> **Vibe:** Architectural Type System is a minimalist, monochrome aesthetic focusing on rigid grid structures, h...

## Reference Images

> 이 프롬프트를 사용하면 아래와 같은 스타일로 결과물이 나옵니다.

![Architectural Type System Style Design System](../images/architectural-type-system-style/reference.png)
